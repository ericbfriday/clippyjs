export type AgentName = "Clippy" | "Bonzi" | "F1" | "Genie" | "Genius" | "Links" | "Merlin" | "Peedy" | "Rocky" | "Rover";
...
export type ContentBlock = TextBlock | ImageBlock | ToolUseContentBlock | ToolResultContentBlock;
export interface Message {
    role: MessageRole;
    content: string | ContentBlock[];
}
export type StreamChunkType = 'content_delta' | 'tool_use' | 'tool_use_start' | 'tool_use_delta' | 'complete' | 'error';
